          ...
          <section className="hero">
            ...
            <div className="container">
              ...
              <div className="hero-actions">
                ...
                <button onClick={() => navigateTo('about')} className="btn-hero-outline">
                  Our Mission
                </button>
              </div>
              ...
              <div className="about-card">
                <div className="about-content">
                  ...
                  <p>
                    ...
                    that make a difference in people's lives. Founded with the vision
                    of bridging the gap between technology and human needs, we strive
                    to build products that are not only functional but also intuitive
                    and accessible to everyone.
                  </p>

                  <h2>Our Mission</h2>
                  <p>
                    To empower individuals and organizations through cutting-edge
                    technology, fostering growth, creativity, and sustainable
                    development in everything we do.
                  </p>

                  <h2>Our Values</h2>
                  <ul className="about-values">
                    <li><CheckCircle size={18} color="var(--primary)" /> <strong>Innovation:</strong> We embrace new ideas and technologies</li>
                    <li><CheckCircle size={18} color="var(--primary)" /> <strong>Quality:</strong> We deliver excellence in every project</li>
                    <li><CheckCircle size={18} color="var(--primary)" /> <strong>Collaboration:</strong> We work together to achieve common goals</li>
        ...
        <div className="container">
          <div className="footer-grid">
            <div style={{gridColumn: 'span 2'}}>
              <div className="logo-area" style={{marginBottom:'1.5rem'}} onClick={() => navigateTo('home')}>
            ...
            <div>
              ...
              <ul style={{listStyle:'none', display:'grid', gap:'1rem', color:'var(--slate-500)', fontSize:'0.875rem'}}>
                <li><button onClick={() => navigateTo('home')} style={{background:'none', border:'none', color:'inherit', cursor:'pointer'}}>Integrations</button></li>
                <li><button onClick={() => navigateTo('home')} style={{background:'none', border:'none', color:'inherit', cursor:'pointer'}}>API Docs</button></li>
                <li><button onClick={() => navigateTo('about')} style={{background:'none', border:'none', color:'inherit', cursor:'pointer'}}>Case Studies</button></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul style={{listStyle:'none', display:'grid', gap:'1rem', color:'var(--slate-500)', fontSize:'0.875rem'}}>
                <li><button onClick={() => navigateTo('about')} style={{background:'none', border:'none', color:'inherit', cursor:'pointer'}}>About Us</button></li>
                <li><button onClick={() => navigateTo('home')} style={{background:'none', border:'none', color:'inherit', cursor:'pointer'}}>Careers</button></li>
                <li><button onClick={() => navigateTo('home')} style={{background:'none', border:'none', color:'inherit', cursor:'pointer'}}>Contact</button></li>
              </ul>
            </div>
          </div>
